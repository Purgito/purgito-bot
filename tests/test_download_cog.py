...
# Los tests de embed_video_url/embed_image_url/is_direct_media_host/
# fetch_direct_media_bytes/fetch_media_bytes/resolve_reference/
# reply_target_url viven en tests/test_discord_media.py -- son de
# discord_media.py, compartido con cogs/imagefx.py, no lógica propia de
# "!dl".
