...
# --- Configuración TTS ---
TTS_MAX_TEXT_LENGTH = env_int("TTS_MAX_TEXT_LENGTH", 300)
TTS_MAX_QUEUE_PER_GUILD = env_int("TTS_MAX_QUEUE_PER_GUILD", 20)
TTS_MAX_CONCURRENT_GENERATIONS = env_int("TTS_MAX_CONCURRENT_GENERATIONS", 3)
TTS_CACHE_MAX_BYTES = env_int("TTS_CACHE_MAX_BYTES", 500 * 1024 * 1024)
TTS_DEFAULT_VOICE = os.getenv("TTS_DEFAULT_VOICE", "es_002")
TTS_EDGE_FALLBACK_VOICE = os.getenv("TTS_EDGE_FALLBACK_VOICE", "es-ES-AlvaroNeural")
TTS_CIRCUIT_BREAKER_FAILURES = env_int("TTS_CIRCUIT_BREAKER_FAILURES", 3)
TTS_CIRCUIT_BREAKER_RESET_TIMEOUT = env_int("TTS_CIRCUIT_BREAKER_RESET_TIMEOUT", 60)
TTS_CACHE_TTL_DAYS = env_int("TTS_CACHE_TTL_DAYS", 7)
TTS_REQUEST_TIMEOUT_SECONDS = float(os.getenv("TTS_REQUEST_TIMEOUT_SECONDS", "8.0"))
