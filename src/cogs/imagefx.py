...
del otro bot, ver proxy_url en cogs/download.py:_embed_video_url) y, por
último, un link propio o del mensaje respondido igual que "!dl" (mismo
allowlist de hosts, mismo módulo)."""
...
async def _resolve_video_bytes(ctx: commands.Context) -> bytes | None:
    ...
    ahí gif_cmd todavía prueba un link de página antes de rendirse."""
