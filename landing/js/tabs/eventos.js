...
addStrings({
  es: {
    ...
    'tabsEventos.noTemplatesHint': 'Todavía no tienes plantillas — crea una para poder asignarla aquí.',
    ...
    'tabsEventos.templateMissingNotice': 'La plantilla asignada a este evento ya no existe — elige otra.',
