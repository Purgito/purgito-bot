...
addStrings({
  es: {
    ...
    'tabsYoutube.idPlaceholder': 'ID, @handle o URL del canal de YouTube',
    'tabsYoutube.fillFields': 'Completa el canal y elige un canal de Discord',
    ...
    'tabsYoutube.addSubHint': 'Ingresa el ID del canal (UC…), su @handle o la URL completa de YouTube.',
  ...
  en: {
    ...
    'tabsYoutube.idPlaceholder': 'YouTube channel ID, @handle, or URL',
    'tabsYoutube.fillFields': 'Fill in the YouTube channel and pick a Discord channel',
    ...
    'tabsYoutube.addSubHint': 'Enter the YouTube channel ID (UC…), its @handle, or the full URL.',
