...
const ACTION_LABELS = {
  ...
  'excluded_users.add': 'Excluyó a un usuario de interacciones o aprendizaje',
  'excluded_users.update': 'Actualizó la exclusión de un usuario',
  'excluded_users.remove': 'Eliminó la exclusión de un usuario',
