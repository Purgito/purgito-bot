...
addStrings({
  es: {
    ...
    'tabsHistorial.action.anuncios.create': 'Creó un anuncio programado',
    'tabsHistorial.action.anuncios.update': 'Actualizó un anuncio programado',
    'tabsHistorial.action.anuncios.delete': 'Eliminó un anuncio programado',
    ...
    'tabsHistorial.action.prefix.set': 'Cambió el prefijo de comandos',
    ...
    'tabsHistorial.action.twitch.add': 'Agregó una suscripción de Twitch',
    'tabsHistorial.action.twitch.remove': 'Eliminó una suscripción de Twitch',
    'tabsHistorial.action.twitch.update_mention_role': 'Cambió el rol de mención de Twitch',
  ...
  en: {
    ...
    'tabsHistorial.action.anuncios.create': 'Created a scheduled announcement',
    'tabsHistorial.action.anuncios.update': 'Updated a scheduled announcement',
    'tabsHistorial.action.anuncios.delete': 'Deleted a scheduled announcement',
    ...
    'tabsHistorial.action.prefix.set': 'Changed the command prefix',
    ...
    'tabsHistorial.action.twitch.add': 'Added a Twitch subscription',
    'tabsHistorial.action.twitch.remove': 'Removed a Twitch subscription',
    'tabsHistorial.action.twitch.update_mention_role': 'Changed the Twitch mention role',
...
const ACTION_LABELS = {
  ...
  'anuncios.create': t('tabsHistorial.action.anuncios.create'),
  'anuncios.update': t('tabsHistorial.action.anuncios.update'),
  'anuncios.delete': t('tabsHistorial.action.anuncios.delete'),
  ...
  'prefix.set': t('tabsHistorial.action.prefix.set'),
  ...
  'twitch.add': t('tabsHistorial.action.twitch.add'),
  'twitch.remove': t('tabsHistorial.action.twitch.remove'),
  'twitch.update_mention_role': t('tabsHistorial.action.twitch.update_mention_role'),
